...
function getMultiLanguageContent(): MultiLanguageQuestionAndAnswer[] {
  return [
    ...
    },
    {
      ...
      answer: {
        en:
          'If you’ve already got the basics (aperture, shutter speed, ISO, depth of field, etc.), we still recommend Photato. For you, the weekly topics, ideas, alternative versions, pro tips might be exciting. In case you’re an even more professional photographer, then we suggest 2 things:' +
          '<ol>' +
          ...
          '</ol>',
        hu:
          'Ha a fotózási alapok (blende, záridő, ISO érték, mélységélesség, stb.) már megvannak, akkor is ajánljuk a Photatot. Neked inkább a heti témák, az ötletek, alternatív változatok, haladóbb tippek lehetnek izgalmasabbak. Ha még profibb fotós vagy, akkor két dolgot ajánlunk:' +
          '<ol>' +
