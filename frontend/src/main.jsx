import {config, developmentConfig, stagingConfig, productionConfig} from './config.jsx';
import React, {StrictMode} from 'react';
import {render} from 'react-dom';
import ReactGA from 'react-ga';
import ReactPixel from './website/reactPixel.js';
// import LogRocket from 'logrocket';

import {Auth0Provider} from "./auth/components/Auth0Provider.jsx";
import I18nProvider from "./i18n/components/I18nProvider.jsx";
import CourseDataProvider from './challenges/components/CourseDataProvider.jsx';

import {getDefaultLocaleCodeByNavigatorPreferences} from './i18n/i18nHelper.jsx';
import {availableLocaleCodes} from './i18n/locales.jsx';

import App from './website/components/App.jsx';

import CourseDateConverter from './challenges/CourseDateConverter.jsx';
