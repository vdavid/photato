...
import MaterialContextProvider from './MaterialContextProvider.jsx';
...
export default function MaterialPage() {
    ...
    useEffect(() => {
        ...
        async function loadArticle() {
            const content = await import((`../${isExternalArticle ? 'third-party' : 'own'}-content/${languageCode}/${slug}.jsx`));
