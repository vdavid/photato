...
import {ownArticleSlugsByLanguageAndByWeek, thirdPartyArticleSlugsByLanguageAndByWeek} from '../articles-repository.jsx';
...
export default function MaterialsPage() {
    ...
    useEffect(() => {
        ...
        function loadArticlesForOneWeek(slugs, ownership) {
            return Promise.all(slugs.map(slug => import((`../${ownership}-content/${languageCode}/${slug}.jsx`))));
        }
