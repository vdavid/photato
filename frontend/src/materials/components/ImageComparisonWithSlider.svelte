<script lang="ts">
    ...
    let {fileName1, fileName2, caption, width = '600px'}: Props = $props();
    ...
    let sliderTop = $derived((imageHeight / 2) - ((sliderRef?.offsetHeight ?? 0) / 2));
    let sliderX = $derived(sliderXPercent * imageWidth);
...
<div class="imageComparison" style="width: {width}">
    <figure>
        <div class="primary">
            <img bind:this={primaryImageRef} src={imageBaseUrl + fileName1} alt="Image 1" onload={updateImageDimensions}/>
        </div>
