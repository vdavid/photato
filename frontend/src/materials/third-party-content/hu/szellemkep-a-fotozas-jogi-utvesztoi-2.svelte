...
<p>
    <Link to="/hu/external-article/szellemkep-a-fotozas-jogi-utvesztoi-1">Cikksorozatunk első részében</Link> a fotózás jogi szabályozásának alapjait, az engedélyköteles fotók jellemzőit, illetve az engedély megadásának módját jártuk körül. Mostani írásunkban az engedély nélküli fotózás jogkövetkezményeit mutatjuk be, és megpróbálunk útmutatást adni a megfelelő eljárásra is.
</p>
...
<p>
    <em>(A tömegrendezvényen részt vevőkről, illetve a nyilvános közszereplés során készített, engedély nélküli fotózásról <Link to="/hu/external-article/szellemkep-a-fotozas-jogi-utvesztoi-3">következő írásunkban</Link> olvashatnak.)</em>
</p>
