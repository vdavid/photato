...
<ol>
    ...
    <li><strong>Úsztatás (“svenkelés”/”behúzás”).</strong> Azt jelenti, hogy a kamerát folyamatosan mozgatva követed a fotótémád mozgását. Ezzel elérheted, hogy a tárgyad éles lesz, míg a háttér elmosódik. Ez <ExternalLink href="https://hu.pinterest.com/search/pins/?q=panning%20photography">nagyon menőn tud kinézni</ExternalLink>.<br />
        ...
        Ez a módszer csak akkor működik, ha tudod előre, hogy milyen pályán fog mozogni a témád. Emellett érdemes tudni, hogy ez a nehezebb technikák egyike: keveseknek sikerül elsőre jó képekeket készíteni vele. De ha tetszik, érdemes gyakorolnod, és előbb-utóbb ráérzel.</li>
...
<ul>
    <li>Fotózás alapok: <ExternalLink href="https://fotozasblog.hu/digitalis-fotozas/">rekesz, záridő, zoom</ExternalLink> | <Link to="/hu/external-article/fotozasblog-iso-erzekenyseg-fenymeres-beepitett-vaku">fénymérés, ISO, vaku</Link>.</li>
