...
<p>A cél, hogy a fehér szín tényleg fehér legyen, ne pedig sárga, kékes stb. Bővebb infókért jó szívvel ajánljuk a témában <ExternalLink href="https://studioeszkozok.hu/feheregyensuly-es-szinhomerseklet-a-digitalis-fotoknal">a studioeszkozok.hu cikkét</ExternalLink>. (<Link to="/hu/external-article/studioeszkozok-feheregyensuly-es-szinhomerseklet-a-digitalis-fotoknal">🥔📷 mentett verzió</Link>) </p>
