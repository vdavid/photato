...
<ul>
    ...
    <li>Az utcai fotózás jogi háttere Magyarországon (3 részes cikk a Photato oldalán): <Link to="/hu/external-article/szellemkep-a-fotozas-jogi-utvesztoi-1">[1]</Link> <Link to="/hu/external-article/szellemkep-a-fotozas-jogi-utvesztoi-1">[2]</Link> <Link to="/hu/external-article/szellemkep-a-fotozas-jogi-utvesztoi-1">[3]</Link></li>
