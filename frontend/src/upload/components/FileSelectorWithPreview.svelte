<script lang="ts">
    ...
    const { selectedFile, selectedFilePreviewUrl, onFileSelected, onFileRemoved, isDisabled }: Props = $props()
    ...
    const orientationCss = $derived(orientationFixer.getCssTransformationByOrientationValue(orientation))
