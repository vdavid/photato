...
import Error404Page from '../../website/components/Error404Page.jsx';
    ...
    useEffect(() => {
        if ((weekIndex >= 1) && (currentWeekIndex >= weekIndex)) {
            ...
            async function loadChallenge() {
                try {
                    setChallenge({isLoaded: true, component: (await import('../content/' + languageCode + '/Week' + weekIndex + 'Challenge.jsx')).default});
                } catch(error) {
