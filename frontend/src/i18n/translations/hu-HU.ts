...
const articlePageTranslations: TranslationMap = {
    ...
    'Some of these articles are not our own. [...]': {
        translation: '<em>A cikkek egy részét nem mi írtuk.</em> Csak szerintünk nagyon jók. Ezeket onnan ismered meg, hogy oda van írva az eredeti szerző, pl. “Sg.hu”, és másképp néz ki a link.<br/>' +
            ...
            'Ha működik az eredeti link, arra kérünk, <em>olvasd az eredetit</em>, a látogatásoddal támogatva a szerzőket.', format: 'html',
    },
    ...
    'Photato cached version': {translation: '<img draggable="false" class="emoji" alt="🥔📷" src="/website/aperture-logo.svg"/> mentett verzió', format: 'html'},
...
const otherTranslations: TranslationMap = {
    ...
    /* Loading page */
    'Loading seems to take longer than usual. If you think this is a problem, please report it here.': {translation: 'Úgy tűnik, a betöltés tovább tart, mint szokott. Ha szerinted nálunk van a gond, légyszi jelezd ezt a <a href="mailto:photatophotato@gmail.com?subject=Weboldal probléma, sokáig tart a betöltés!">photatophotato@gmail.com</a> címen.', format: 'html'},
    ...
    'Enter your email and we’ll send you a login link.': {translation: 'Add meg az e-mail címed, és küldünk egy bejelentkező linket.'},
    'Your email address': {translation: 'Az e-mail címed'},
    'Send me a login link': {translation: 'Küldjétek a bejelentkező linket'},
    'Check your email for a login link.': {translation: 'Elküldtük a bejelentkező linket! Nézd meg a postaládád, és kattints a linkre a belépéshez.'},
    'Signing you in…': {translation: 'Bejelentkezés folyamatban…'},
    'This link is invalid or has expired — request a new one.': {translation: 'Ez a link érvénytelen vagy lejárt – kérj egy újat.'},
