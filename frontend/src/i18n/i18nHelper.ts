...
function _getLocaleCodeByNavigatorPreference(navigatorLocaleCode: string): string | undefined {
  return (
    availableLocaleCodes.find((localeCode) => localeCode === navigatorLocaleCode) ||
 ...
 *          a language switcher.
 */
export function getDefaultLocaleCodeByNavigatorPreferences(
  navigatorPreferences: readonly string[] = window.navigator.languages,
): string {
