...
export const config = {
    environment: '', // Will be set to 'development', 'staging', or 'production' by main.jsx
    baseUrl: '', // Will be set by main.jsx. E.g. "https://photato.eu". Will not contain a slash at the end.
    auth0: {
        domain: '', // Will be set by main.jsx
        clientId: '', // Will be set by main.jsx
    },
    course: {
        name: 'hu-4',
        weekCount: 12,
