...
export default class EmojiReplacer {
     ...
     */
    constructor({defaultAssetsBaseUrl, defaultFileExtension, defaultSize, defaultClassName}: EmojiReplacerOptions = {}) {
    ...
    parse(what: string | HTMLElement, {callback, attributes, base, ext, folder, size, className, onerror}: EmojiParseOptions = {}): string | HTMLElement {
